					...
					<div className="px-4 py-6 mx-auto max-w-7xl md:px-6">
						<section className="mb-8">
							<div className="flex items-center justify-between mb-4">
								<h2 className="text-xl font-semibold font-heading text-text-primary">Nearby Deals</h2>
								<button
						...
						<section className="mb-8">
							<div className="flex items-center justify-between mb-4">
								<h2 className="text-xl font-semibold font-heading text-text-primary">Recently Viewed</h2>
								<button
						...
						<section className="mb-8">
							<div className="flex items-center justify-between mb-4">
								<h2 className="text-xl font-semibold font-heading text-text-primary">Popular in Your Area</h2>
								<button
